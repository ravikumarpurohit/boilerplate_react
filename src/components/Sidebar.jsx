  ...
  return (
    ...
    >
      ...
      <div className=" flex-1 p-4 flex flex-col">
        ...
        <div className=" mt-4 relative flex gap-2 px-4">
          <select
            name="businessId"
            id=""
            value={businessId ? businessId : ""}
            onChange={(e) => handleBusinessIdChange(e)}
            className=" bg-[#DCE5FF] py-1 px-4 rounded-lg shadow-inner-dropdown outline-none w-full appearance-none cursor-pointer"
          >
            {user &&
